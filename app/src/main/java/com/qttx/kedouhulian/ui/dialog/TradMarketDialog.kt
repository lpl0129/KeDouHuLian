 ...
 * @date 2019/4/16 0016
 */
class TradMarketDialog constructor(mContext: Context) : AttachPopupView(mContext) {

    private var selectListener: OnSelectListener? = null

    override fun getImplLayoutId(): Int {
        return R.layout.trade_pop_market
    ...
    fun setOffsetXAndY(offsetX: Int, offsetY: Int): TradMarketDialog {
        this.defaultOffsetX += offsetX
        this.defaultOffsetY += offsetY
        return this
    }
    fun setOnSelectListener(selectListener: OnSelectListener): TradMarketDialog {
