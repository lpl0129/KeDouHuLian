...
public class SealSearchChattingDetailActivity extends BaseActivity {
    ...
    private class ChattingRecordsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            UserInfo userInfo = new UserInfo(id, title, mResult.getPortraitUri());

            RequestOptions options=new RequestOptions();
            Glide.with(SealSearchChattingDetailActivity.this).load(userInfo.getPortraitUri()).apply(options).into(viewHolder.portraitImageView);
